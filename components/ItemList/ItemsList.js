...
import { ItemPageWrapper } from '../../styles/HomePageWrapper.css';
...
const ItemsList = ({
  ...
  return (
    <ItemPageWrapper>
      <div className="mb-4">
        <div className=" mb-6 bg-gray-900 text-white" >
          <div className="grid grid-cols-12 mb-2">
            <p className="col-span-1">{value.s_no}</p>
            <p className="col-span-3">{value.particulars}</p>
            <p className="col-span-2">{value.hsn_code}</p>
            <p className="col-span-2">{value.hours}</p>
            <p className="col-span-2">{value.amount}</p>
            <p className="col-span-2">{`${value.total}(${currency})`}</p>
        ...
        <a className="text-brand mr-8 font-bold" onClick={addNewRow}><span className=" text-md p-1">+</span> Add row to the list</a>
        <a className="text-brand font-bold m-2"><span className=" text-md p-1">+</span> Add Column to the list</a>
