                ...
                <div key={row._id} className="shadow border rounded-lg">
                    <div className="flex items-center space-x-4 p-4">
                        ...
                        <div className="flex-1">
                            <p className="text-gray-500 font-semibold">{row.city}</p>
                    ...
                    <a href="#" className="block p-3 text-lg font-semibold bg-purple-50 text-purple-800 hover:bg-purple-100 cursor-pointer">
                        View all
                    </a>
                </div>
            ))
