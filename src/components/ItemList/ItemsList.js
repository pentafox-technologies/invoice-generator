  ...
  return (
    <>
      <div className="mb-4">
            ...
            count.map(value => {
              ...
              return (
                <div className="grid grid-cols-12">
                  <textarea type="text" value={value.item_desc} className="mr-2 col-span-6 text-sm  focus:outline-none  hover:bg-yellow-100 focus:bg-yellow-100" onChange={(e) => handleClick(e)} />
                  <input type="text" value={value.item_hsn_code} className="focus:outline-none mr-2 h-5 hover:bg-yellow-100  focus:bg-yellow-100 col-span-3 text-sm text-right" onChange={(e) => handleClick(e)} />
        ...
        <span className="cursor-pointer font-semibold text-sm text-blue-800" onClick={() => counter()}>+ Add Item to the list</span>
      </div>
