            ...
            <div className="absolute w-full">
                <div className="bg-white justify-items-stretch mb-12 h-16">
                    <div className="float-right flex mb-12">
                        <svg xmlns="http://www.w3.org/2000/svg" class="h-12 w-12 py-1 mx-2 mt-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <div className= "p-4 px-8 text-3xl bg-white ml-60 h-20 mb-12 font-light">
                    <h4>Add Invoice</h4>
