    ...
    <div className="mb-12">
      ...
      <div className="text-gray-500 mb-4" >
        <div className="grid grid-cols-12  mb-2 lg:text-sm text-xs">
          ...
          <input type="text" name={"t_issue_date"} value={value.t_issue_date} className="col-span-4 font-semibold mr-2 text-right focus:outline-none hover:bg-yellow-100 focus:bg-yellow-100" onChange={(e) => handleChange(e)} />
        ...
        <div className="grid grid-cols-12"> 
          ...
          <input name={"issue_date"} type="" value={value.issue_date} className="col-span-4 mr-2 text-sm text-right focus:outline-none max-h-12 hover:bg-yellow-100 focus:bg-yellow-100" onChange={(e) => handleChange(e)} />
